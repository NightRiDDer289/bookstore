...
> O Render provisiona o banco PostgreSQL automaticamente. Copie a `DATABASE_URL` fornecida e mapeie para as variáveis `SQL_*` do projeto, ou ajuste o `settings.py` para usar `DATABASE_URL` diretamente.
